...
with col_map:
    ...
    if show_heatmap:
        ...
        # Rewritten to eliminate multi-line chaining syntax ambiguity
        heatmap_layer = HeatMap(heat_matrix, radius=40, blur=25, min_opacity=0.4, gradient={0.2: 'blue', 0.4: 'lime', 0.6: 'orange', 1.0: 'red'})
    ...
    folium.Marker(
        ...
        icon=folium.Icon(color='red' if active["color"] == 'darkred' else active["color"], icon="mountain", prefix="fa")
    ).add_to(m)
